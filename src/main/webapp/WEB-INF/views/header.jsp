			...
			<div id="header-content">
				<nav id="main-nav">
					...
					<ul class="clearfix">
						...
						<li><a href="${path}produtos/form" rel="nofollow">Cadastrar Produto</a></li>
						
						<li><a href="${path}" rel="nofollow">Lista Produtos</a></li>
					
						<li><a href="${path}carrinho" rel="nofollow">Carrinho(${carrinhoCompras.quantidade})</a></li>
